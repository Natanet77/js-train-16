...
function compareArrays(arr1, arr2) {
  arr1.sort((a, b) => a - b);
  arr2.sort((a, b) => a - b);
  const compareArr1 = JSON.stringify(arr1);
  const compareArr2 = JSON.stringify(arr2);
  console.assert(compareArr1 === compareArr2, "Масиви не однакові!");
